...
export const BlogHeader = ({
  ...
  return (
    <Container className="grid grid-cols-1 gap-10 py-10 lg:grid-cols-2 lg:items-center lg:gap-15 lg:py-30">
      <div className="flex h-full flex-col items-center justify-between gap-6 pt-8 lg:items-start">
        <div className="flex flex-col items-center gap-6 lg:items-start">
          ...
          <h1 className="-tracking-xl text-center text-5xl leading-14 font-medium lg:text-start">
            {page.data.title}
          </h1>
          <p className="text-muted-foreground -tracking-xs text-center text-base leading-6 font-medium lg:text-start">
