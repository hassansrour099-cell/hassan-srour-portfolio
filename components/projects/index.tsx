  ...
  return (
    <li>
      <Link
        ...
        onFocus={onFocus}
        className={cn(
          "group relative grid gap-4 py-8 outline-none transition-colors duration-200 md:grid-cols-12 md:gap-6 md:py-10",
      ...
      >
        ...
        <div className="flex items-start justify-end md:col-span-1">
          <span
            aria-hidden
            className={cn(
              "font-display text-lg text-primary transition-transform duration-200",
